        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Thêm biến thể Laptop</h4>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="variant_name" id="variant_name" class="form-control" placeholder="Nhập tên biến thể" required>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="stock" id="stock" class="form-control" placeholder="Nhập tồn kho" required>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="specifications" id="specifications" class="form-control" rows="4" placeholder="Nhập thông số..."></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
