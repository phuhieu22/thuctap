...
<head>
    ...
    <meta name="keywords"
        content="{{ $laptop->brand->name ?? 'Product' }}, {{ $laptop->model ?? 'Details' }}, {{ $laptop->category->name ?? 'Category' }}">
            ...
            <div class="container">
                <div class="d-flex py-3 align-items-center justify-content-between">
                    ...
                    <div class="header-actions d-flex align-items-center">
                        <a href="{{ route('login') }}" class="btn btn-link me-2">
    ...
    <main class="main">
        <div class="page-title">
            <div class="container d-lg-flex justify-content-between align-items-center">
                <h1 class="mb-2 mb-lg-0">{{ $laptop->brand->name ?? 'Product' }} {{ $laptop->model ?? 'Details' }}
                </h1>
                <nav class="breadcrumbs">
                    <ol>
                        <li><a href="{{ route('laptops.index') }}">Home</a></li>
                        <li><a href="{{ route('laptops.index') }}">{{ $laptop->category->name ?? 'Category' }}</a>
                        </li>
                ...
                <div class="row">
                        ...
                        <div class="product-images">
                            <div class="main-image-container mb-3">
                                @if ($laptop->images && $laptop->images->count() > 0)
                                    <img src="{{ $laptop->images->first()->url }}" alt="{{ $laptop->model }}"
                                        class="img-fluid main-image w-100" id="main-product-image"
                                        style="height: 400px; object-fit: cover;">
                                @else
                                    <img src="https://via.placeholder.com/600x400?text=No+Image" alt="Product Image"
                                        class="img-fluid main-image w-100" id="main-product-image"
                                        style="height: 400px; object-fit: cover;">
                                @endif
                            </div>
                                ...
                                <div class="d-flex gap-2">
                                    @if ($laptop->images && $laptop->images->count() > 0)
                                        @foreach ($laptop->images as $index => $image)
                                            <div class="thumbnail-item {{ $index === 0 ? 'active' : '' }}"
                                                data-image="{{ $image->url }}" style="width: 80px; height: 80px;">
                                                <img src="{{ $image->url }}"
                                    ...
                                    @else
                                        <div class="thumbnail-item active"
                                            data-image="https://via.placeholder.com/600x400?text=No+Image"
                                            style="width: 80px; height: 80px;">
                                            <img src="https://via.placeholder.com/80x80?text=1"
                                                alt="Product Thumbnail" class="img-fluid w-100 h-100"
                                                style="object-fit: cover;">
                                        </div>
                                        <div class="thumbnail-item"
                                            data-image="https://via.placeholder.com/600x400?text=Image+2"
                                            style="width: 80px; height: 80px;">
                                        ...
                                        <div class="thumbnail-item"
                                            data-image="https://via.placeholder.com/600x400?text=Image+3"
                                            style="width: 80px; height: 80px;">
                                            <img src="https://via.placeholder.com/80x80?text=3"
                                                alt="Product Thumbnail" class="img-fluid w-100 h-100"
                                                style="object-fit: cover;">
                                        </div>
                                    @endif
                    ...
                    <div class="col-lg-6">
                        <div class="product-info">
                            ...
                            <h1 class="product-title mb-3">{{ $laptop->brand->name ?? 'Brand' }}
                                {{ $laptop->model ?? 'Wireless Noise Cancelling Headphones' }}</h1>
                            ...
                            <div class="product-short-description mb-4">
                                <p>{{ $laptop->description ?? 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum at lacus congue, suscipit elit nec, tincidunt orci. Phasellus egestas nisi vitae lectus imperdiet venenatis.' }}
                                </p>
                            </div>
                            ...
                            <div class="product-quantity mb-4">
                                ...
                                <div class="quantity-selector" id="quantity-selector">
                                    ...
                                    <input type="number" class="quantity-input" id="quantity-input" value="1"
                                        min="1" max="{{ $laptop->stock ?? 24 }}" readonly>
                            ...
                            <div class="product-actions mb-4 d-flex gap-2">
                                <form action="{{ route('cart.add') }}" method="POST">
                                    @csrf
                                    <input type="hidden" name="laptop_variant_id" value="{{ $variant->id }}">
                        ...
                        <ul class="nav nav-tabs" id="productTabs" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="reviews-tab" data-bs-toggle="tab"
                                    data-bs-target="#reviews" type="button" role="tab">Reviews (42)</button>
                            </li>
                        </ul>
                                ...
                                <div class="product-description">
                                    ...
                                    <ul>
                                        ...
                                        <li><strong>Category:</strong>
                                            {{ $laptop->category->name ?? 'High-Performance Category' }}</li>
                                        <li><strong>Price:</strong> ${{ number_format($laptop->price ?? 249.99, 2) }}
                                        </li>
                                        @if ($laptop->variants && $laptop->variants->count() > 0)
                                            <li><strong>Available Variants:</strong> {{ $laptop->variants->count() }}
                                                options</li>
                                        @endif
                                    </ul>
                                    ...
                                    <ul>
                                        <li>{{ $laptop->brand->name ?? 'Premium' }}
                                            {{ $laptop->model ?? 'Wireless Headphones' }}</li>
                                        <li>Carrying Case</li>
                                    ...
                                    <div class="specs-group">
                                        ...
                                        <div class="specs-table">
                                            <div class="specs-row">
                                                ...
                                                <div class="specs-value">{{ $laptop->brand->name ?? 'Premium Brand' }}
                                                </div>
                                            </div>
                                            <div class="specs-row">
                                            ...
                                            <div class="specs-row">
                                                ...
                                                <div class="specs-value">
                                                    {{ $laptop->category->name ?? 'Electronics' }}</div>
                                            </div>
                                            <div class="specs-row">
                                                <div class="specs-label">Price</div>
                                                <div class="specs-value">
                                                    ${{ number_format($laptop->price ?? 249.99, 2) }}</div>
                                            </div>
                                            <div class="specs-row">
                                            ...
                                            <div class="specs-row">
                                                ...
                                                <div class="specs-value">{{ $laptop->images->count() ?? 5 }} images
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="rating-breakdown">
                                                    @foreach ([5, 4, 3, 2, 1] as $stars)
                                                        <div class="d-flex align-items-center mb-2">
                                                            <span class="me-2"
                                                                style="width: 60px;">{{ $stars }} stars</span>
                                                            <div class="progress flex-fill me-2" style="height: 8px;">
                                                                <div class="progress-bar bg-warning"></div>
                                                            </div>
                                                            <span
                                                                style="width: 30px;">{{ [27, 10, 3, 1, 1][$loop->index] }}</span>
                                                        </div>
                                                    @endforeach
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="star-rating">
                                                    @for ($i = 5; $i >= 1; $i--)
                                                        ...
                                                        <label for="star{{ $i }}"
                                                            title="{{ $i }} stars"
                                                            class="text-warning me-1" style="cursor: pointer;">
                                                            <i class="bi bi-star-fill"></i>
                                                        </label>
                                                    @endfor
                                                </div>
                                            ...
                                            $reviews = [
                                                [
                                                    ...
                                                    'title' =>
                                                        ...
                                                        ($laptop->brand->name ?? 'this brand'),
                                                    'content' =>
                                                        'This ' .
                                                        ($laptop->model ?? 'product') .
                                                        ' exceeded my expectations. Great build quality and performance. Highly recommended for anyone looking for a reliable ' .
                                                ...
                                                [
                                                    ...
                                                    'content' =>
                                                        'Excellent ' .
                                                        ($laptop->category->name ?? 'product') .
                                                        ' at this price point. The ' .
                                                        ($laptop->brand->name ?? 'brand') .
                                                        ' quality is evident. Minor issues but overall very satisfied with the purchase.',
                                                ],
                                                [
                                                    ...
                                                    'content' =>
                                                        'The ' .
                                                        ($laptop->model ?? 'product') .
                                                        ' performs exceptionally well. Fast delivery and great customer service. Would definitely buy from ' .
                                                        ($laptop->brand->name ?? 'this brand') .
                                                        ' again.',
                                                ],
                                            ];
                                        ...
                                        @foreach ($reviews as $review)
                                            <div class="review-item">
                                                <div class="d-flex justify-content-between align-items-start mb-3">
                                                    <div class="d-flex">
                                                        <img src="https://via.placeholder.com/50x50?text={{ substr($review['name'], 0, 1) }}"
                                                            alt="Reviewer" class="reviewer-avatar me-3">
                                                        <div>
                                                            <h5 class="reviewer-name mb-1">{{ $review['name'] }}</h5>
                                                            <div class="review-date text-muted">{{ $review['date'] }}
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col-md-3 mb-4">
                                        <div class="card h-100">
                                            @if ($relatedLaptop->images && $relatedLaptop->images->count() > 0)
                                                <img src="{{ $relatedLaptop->images->first()->url }}"
                                            ...
                                            @endif
                                            <div class="card-body">
                                                <h6 class="card-title">{{ $relatedLaptop->brand->name }}
                                                    {{ $relatedLaptop->model }}</h6>
                                                <p class="card-text text-primary fw-bold">
                                                    ${{ number_format($relatedLaptop->price, 2) }}</p>
                                                <a href="{{ route('product.show', $relatedLaptop->id) }}"
